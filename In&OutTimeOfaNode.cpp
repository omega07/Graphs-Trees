...
/*
    ...
    PROBLEM STATEMENT : GIVEN A TREE FIND WHETHER 2 GIVEN NODES LIE IN THE SAME SUBTREE OR NOT..
...
signed main()
{
    ...
    // if visiting_time of ith node lies entirely within the jth node .. i.e in[i] > in[j] && out[i] < out[j] then ith node
    // lies in the subtree of the jth node
    return 0;
}
